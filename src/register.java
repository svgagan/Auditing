...
public class register implements ActionListener 
{
	...
	JButton jbu1,jbu2;
		...
		{
			//Backgroung Image
			iicon=new ImageIcon(this.getClass().getResource("UserLogin.jpg"));
			j3=new JLabel();
			j3.setIcon(iicon);
